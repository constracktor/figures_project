...
plt.plot(hpx_data_left_averaged[:,1], hpx_data_left_averaged[:,6] + hpx_data_left_averaged[:,7], 'go-', label='HPX', linewidth=2)#label='HPX left-looking', linewidth=2)
...
plt.plot(hpx_data_left_averaged[:,1], hpx_data_left_averaged[:,4], 'go-', label='HPX', linewidth=2)#label='HPX left-looking', linewidth=2)
